...
public class ProjectDataUpdate {
     ...
     */
    public void getBuilderProjectList(Map<String, String> cookies, String CompanyQualificationUrl, Integer companyId) {
     ...
     * @param companyId 公司id
     */
    public void getDesignProjectList(Map<String, String> cookies, String CompanyQualificationUrl, Integer companyId) {
        Document projectListDoc;
        Connection projectListConn;
        String peopleListUrl = "http://qyryjg.hunanjz.com/public/EnterpriseProject.ashx";
        try {
...
//                                logger.error(projectBuildUrl);
     ...
     * @param companyId 公司id
     */
    public void getSurveyProjectList(Map<String, String> cookies, String CompanyQualificationUrl, Integer companyId) {
        Document projectListDoc;
        Connection projectListConn;
        String peopleListUrl = "http://qyryjg.hunanjz.com/public/EnterpriseProject.ashx";
        try {
...
//                                    logger.error(projectBuildUrl);
     ...
     * @param companyId 公司id
     */
    public void getSupervisorProjectList(Map<String, String> cookies, String CompanyQualificationUrl, Integer companyId) {
        Document projectListDoc;
        Connection projectListConn;
        String peopleListUrl = "http://qyryjg.hunanjz.com/public/EnterpriseProject.ashx";
        try {
