 ...
 */
@Component
@JobHander(value = "HuNanSurveyCompanyDetailTask")
public class HuNanSurveyCompanyDetailTask extends BaseTask {
    ...
    public void taskSurveyCompany() {
        ...
        urls = companyService.listCompanyQualificationUrlByTab("工程勘察企业");
