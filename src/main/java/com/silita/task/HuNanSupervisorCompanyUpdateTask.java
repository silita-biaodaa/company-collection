...
import IPeopleCertService;
import ISplitCertService;
...
@Component
@JobHander(value = "HuNanSupervisorCompanyUpdateTask")
public class HuNanSupervisorCompanyUpdateTask extends BaseTask {

    @Override
    public void runTask(JSONObject jsonObject) throws Exception {
        supervisorCompanyUpdateTask();
    }
    ...
    public void supervisorCompanyUpdateTask() {
        ...
        for (Map<String, Object> map : maps) {
            ...
            for (int i = 0; i < threadCount; i++) {
                new Thread(new HuNanSupervisorCompanyUpdateRun(i * every, (i + 1) * every, latch, urls)).start();
            }
            try {
                latch.await();
    ...
    class HuNanSupervisorCompanyUpdateRun implements Runnable {
        ...
        public HuNanSupervisorCompanyUpdateRun(int startNum, int endNum, CountDownLatch latch, List<String> CompanyQualificationUrls) {
